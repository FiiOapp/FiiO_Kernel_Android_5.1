...
static struct pcm_format_data pcm_formats[(INT)SNDRV_PCM_FORMAT_LAST+1] = {
    ...
    // for DSD format
	[SNDRV_PCM_FORMAT_DSD64_F32] = {
		.width = 32, .phys = 32, .le = 1, .signd = 0,
		.silence = {0x3c,0xc3,0x3c,0xc3,0x3c,0xc3,0x3c,0xc3},
	},
	[SNDRV_PCM_FORMAT_DSD128_F32] = {
		.width = 32, .phys = 32, .le = 1, .signd = 0,
		.silence = {0x3c,0xc3,0x3c,0xc3,0x3c,0xc3,0x3c,0xc3},
	},
	[SNDRV_PCM_FORMAT_DSD256_F32] = {
		.width = 32, .phys = 32, .le = 1, .signd = 0,
		.silence = {0x3c,0xc3,0x3c,0xc3,0x3c,0xc3,0x3c,0xc3},
	},

	[SNDRV_PCM_FORMAT_DSD64_CT24] = {
		.width = 24, .phys = 32, .le = 1, .signd = 0,
		.silence = { 0x00, 0x00, 0x80 },
	},
	[SNDRV_PCM_FORMAT_DSD128_CT24] = {
		.width = 24, .phys = 32, .le = 1, .signd = 0,
		.silence = { 0x00, 0x00, 0x80 },
	},
	[SNDRV_PCM_FORMAT_DSD256_CT24] = {
		.width = 24, .phys = 32, .le = 1, .signd = 0,
		.silence = { 0x00, 0x00, 0x80 },
	},
	[SNDRV_PCM_FORMAT_SOP] = {
		.width = 32, .phys = 32, .le = 0, .signd = 0,
		.silence = {},
	},
};
