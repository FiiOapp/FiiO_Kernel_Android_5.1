...
#define SNDRV_PCM_RATE_24000		(1<<5)		/* 32000Hz */
...
#define SNDRV_PCM_RATE_128000		(1<<12)		/* 176400Hz */
#define SNDRV_PCM_RATE_176400		(1<<13)		/* 176400Hz */
#define SNDRV_PCM_RATE_192000		(1<<14)		/* 192000Hz */
#define SNDRV_PCM_RATE_352800		(1<<15)		/* 352800Hz */
#define SNDRV_PCM_RATE_384000		(1<<16)		/* 384000Hz */
...
#define SNDRV_PCM_FMTBIT_DSD64_F32   _SNDRV_PCM_FMTBIT(DSD64_F32)
#define SNDRV_PCM_FMTBIT_DSD128_F32  _SNDRV_PCM_FMTBIT(DSD128_F32)
#define SNDRV_PCM_FMTBIT_DSD256_F32  _SNDRV_PCM_FMTBIT(DSD256_F32)

#define SNDRV_PCM_FMTBIT_DSD64_CT24   _SNDRV_PCM_FMTBIT(DSD64_CT24)
#define SNDRV_PCM_FMTBIT_DSD128_CT24  _SNDRV_PCM_FMTBIT(DSD128_CT24)
#define SNDRV_PCM_FMTBIT_DSD256_CT24  _SNDRV_PCM_FMTBIT(DSD256_CT24)
#define SNDRV_PCM_FMTBIT_SOP          _SNDRV_PCM_FMTBIT(SOP)
