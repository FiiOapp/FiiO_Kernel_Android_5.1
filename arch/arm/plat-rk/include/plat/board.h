...
struct bq25890_platform_data {
	...
	u32 vreg;	/* regulation voltage:  battery vol*/

	u32 iprechg;/* precharge current		*/
	u32 ichg;	/* charge current		*/
	u32 iterm;	/* termination current: battery charge full cur	*/
	...
	// u32  tune_count;
	// u32  target_volt;
	u32	 high_volt_level;/* vbus volt > this threshold means tune up successfully */
	u32  low_volt_level; /* vbus volt < this threshold means tune down successfully */
	u32  vbat_min_volt;  /* to tune up voltage only when vbat > this threshold */
