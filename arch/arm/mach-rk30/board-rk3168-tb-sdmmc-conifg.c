...
#else
    #define RK29SDK_SD_CARD_PWR_EN                  RK30_PIN3_PA0
#endif
...
*/
    ...
    #define RK29SDK_SD_CARD_DETECT_N                RK30_PIN3_PB0//INVALID_GPIO
#else
    #define RK29SDK_SD_CARD_DETECT_N                RK30_PIN0_PB5  //According to your own project to set the value of card-detect-pin.
#endif
